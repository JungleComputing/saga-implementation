...
public class LocalDirectoryAdaptor extends DirectoryAdaptorBase {

    private LocalNSDirectoryAdaptor dir;
    
    public LocalDirectoryAdaptor(DirectoryWrapper wrapper, SessionImpl session,
            URL name, int flags) throws NotImplementedException,
            IncorrectURLException, BadParameterException,
            DoesNotExistException, PermissionDeniedException,
            AuthorizationFailedException, AuthenticationFailedException,
            TimeoutException, NoSuccessException, AlreadyExistsException {
        this(wrapper, session, name, flags, new LocalNSDirectoryAdaptor(null,
                session, name, flags & Flags.ALLNAMESPACEFLAGS.getValue()));
    }
    
    public LocalDirectoryAdaptor(DirectoryWrapper wrapper,
            SessionImpl sessionImpl, URL name, int flags,
            LocalNSDirectoryAdaptor dir) throws NotImplementedException,
            IncorrectURLException, BadParameterException,
            DoesNotExistException, PermissionDeniedException,
            AuthorizationFailedException, AuthenticationFailedException,
            TimeoutException, NoSuccessException, AlreadyExistsException {
    ...
    public long getSize(URL name, int flags) throws NotImplementedException,
        ...
        dir.getAdaptorTool().checkURL(name);
