...
java -DUID="%USERNAME%" -classpath "%JAVA_SAGA_LOCATION%\lib\adaptors\JavaGatAdaptor\adaptors\GlobusAdaptor\cog-jglobus.jar;%SAGA_CLASSPATH%" org.globus.tools.ProxyInfo %*
