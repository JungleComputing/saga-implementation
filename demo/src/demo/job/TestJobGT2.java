...
public class TestJobGT2 implements Callback {
   ...
   public static void main(String[] args) {
       ...
       String serverNode = "ngs.rl.ac.uk";
       ...
       System.out.println("try to submit gt2 job to: "+serverNode);
       ...
       try {
           ...
           JobService js = JobFactory.createJobService(URLFactory.createURL(serverNode));
