...
in the \texttt{lib} directory, its name is \texttt{saga-api-1.0rc1.jar}, so
the command
\noindent
{\small
\begin{verbatim}
javac -classpath $SAGA_LOCATION/lib/saga-api-1.0rc1.jar \
    <yourapplication>
\end{verbatim}
}
\noindent
...
to the \texttt{saga-api-1.0rc1} sub-directory.
