...
Introduction.
  This is release 1.1.2 of the SAGA Java implementation, which implements
  release 1.1.2 of the Java SAGA language bindings.
...
Writing a Java SAGA application.
  ...
  $JAVA_SAGA_LOCATION/doc/saga-api-1.1.2/index.html. This documentation is also
