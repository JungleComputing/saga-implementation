...
Introduction.
  This is release 1.0.1 of the SAGA Java implementation, which implements
  release 1.0.1 of the Java SAGA language bindings.
...
Environment variables.
  ...
  implementation in $HOME/workspace/SagaImplementation, then you should have
...
Writing a Java SAGA application.
  ...
  $JAVA_SAGA_LOCATION/doc/saga-api-1.0.1/index.html. This documentation is also
