...
public abstract class StreamServiceAdaptorBase extends
    ...
    public Task<StreamService, Void> close(TaskMode mode, float timeoutInSeconds)
        ...
        return new org.ogf.saga.impl.task.Task<StreamService, Void>(wrapper,
                session, mode, "close", new Class[] { Float.TYPE },
                timeoutInSeconds);
    }

    public Task<StreamService, URL> getUrl(TaskMode mode)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<StreamService, URL>(wrapper,
                session, mode, "getURL", new Class[] {});
    }

    public Task<StreamService, Stream> serve(TaskMode mode,
            float timeoutInSeconds) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<StreamService, Stream>(wrapper,
                session, mode, "serve", new Class[] { Float.TYPE },
                timeoutInSeconds);
    }

    public Task<StreamService, Integer> addCallback(TaskMode mode, String name,
            Callback cb) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<StreamService, Integer>(wrapper,
    ...
    public Task<StreamService, org.ogf.saga.monitoring.Metric> getMetric(
        ...
        return new org.ogf.saga.impl.task.Task<StreamService, org.ogf.saga.monitoring.Metric>(
    ...
    public Task<StreamService, String[]> listMetrics(TaskMode mode)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<StreamService, String[]>(
                wrapper, session, mode, "listMetrics", new Class[] {});
    }

    public Task<StreamService, Void> removeCallback(TaskMode mode, String name,
            int cookie) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<StreamService, Void>(wrapper,
                session, mode, "removeCallback", new Class[] { String.class,
    ...
    public Task<StreamService, String> getGroup(TaskMode mode)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<StreamService, String>(wrapper,
    ...
    public Task<StreamService, Boolean> permissionsCheck(TaskMode mode,
        ...
        return new org.ogf.saga.impl.task.Task<StreamService, Boolean>(wrapper,
