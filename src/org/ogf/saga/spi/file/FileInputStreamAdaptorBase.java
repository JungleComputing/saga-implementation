...
public abstract class FileInputStreamAdaptorBase extends
    ...
    public FileInputStreamAdaptorBase(Session session,
    ...
    public Task<FileInputStream, Integer> read(TaskMode mode)
        ...
        return new org.ogf.saga.impl.task.Task<FileInputStream, Integer>(
                wrapper, session, mode, "read", new Class[] {});
    }

    public Task<FileInputStream, Integer> read(TaskMode mode, byte[] buf,
            int off, int len) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<FileInputStream, Integer>(
                wrapper, session, mode, "read", new Class[] { byte[].class,
    ...
    public Task<FileInputStream, Long> skip(TaskMode mode, long n)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<FileInputStream, Long>(wrapper,
                session, mode, "skip", new Class[] { Long.TYPE }, n);
    }

    public Task<FileInputStream, Integer> available(TaskMode mode)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<FileInputStream, Integer>(
                wrapper, session, mode, "available", new Class[] {});
    }

    public Task<FileInputStream, Void> close(TaskMode mode)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<FileInputStream, Void>(wrapper,
    ...
    public Task<FileInputStream, Void> mark(TaskMode mode, int readlimit)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<FileInputStream, Void>(wrapper,
                session, mode, "mark", new Class[] { Integer.TYPE }, readlimit);
    }

    public Task<FileInputStream, Void> reset(TaskMode mode)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<FileInputStream, Void>(wrapper,
                session, mode, "reset", new Class[] {});
    }

    public Task<FileInputStream, Boolean> markSupported(TaskMode mode)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<FileInputStream, Boolean>(
                wrapper, session, mode, "markSupported", new Class[] {});
    }
}
