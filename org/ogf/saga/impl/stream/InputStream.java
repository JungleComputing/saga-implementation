...
public class InputStream extends org.ogf.saga.stream.StreamInputStream {
    ...
    public Task<Integer> read(TaskMode mode) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<Integer>(this, session, mode, "read",
                new Class[] { });
    }
    ...
    public Task<Long> skip(TaskMode mode, long n) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<Long>(this, session, mode, "skip",
                new Class[] {Long.TYPE}, n);
    }
    
    public Task<Integer> available(TaskMode mode) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task<Integer>(this, session, mode, "available",
                new Class[]{});
    }
    
    public Task close(TaskMode mode) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task(this, session, mode, "close",
                new Class[]{});            
    }
    
    public Task mark(TaskMode mode, int readlimit)
               throws NotImplementedException {        
        return new org.ogf.saga.impl.task.Task(this, session, mode, "mark",
                new Class[]{Integer.TYPE}, readlimit); 
    }
    
    public Task reset(TaskMode mode) throws NotImplementedException {
        return new org.ogf.saga.impl.task.Task(this, session, mode, "reset",
                new Class[]{});        
    }
