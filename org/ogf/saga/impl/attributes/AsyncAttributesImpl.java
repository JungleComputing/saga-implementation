...
public class AsyncAttributesImpl<T> extends AttributesImpl implements
    ...
    public Task<T, String[]> findAttributes(TaskMode mode, String... patterns)
        ...
        return new org.ogf.saga.impl.task.TaskImpl<T, String[]>(object,
                session, mode, "findAttributes",
                new Class[] { String[].class }, (Object[]) patterns);
    }

    public Task<T, String> getAttribute(TaskMode mode, String key)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.TaskImpl<T, String>(object, session,
                mode, "getAttribute", new Class[] { String.class }, key);
    }

    public Task<T, String[]> getVectorAttribute(TaskMode mode, String key)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.TaskImpl<T, String[]>(object,
                session, mode, "getVectorAttribute",
                new Class[] { String.class }, key);
    }

    public Task<T, Boolean> existsAttribute(TaskMode mode, String key)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.TaskImpl<T, Boolean>(object, session,
                mode, "existsAttribute", new Class[] { String.class }, key);
    }

    public Task<T, Boolean> isReadOnlyAttribute(TaskMode mode, String key)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.TaskImpl<T, Boolean>(object, session,
                mode, "isReadOnlyAttribute", new Class[] { String.class }, key);
    }

    public Task<T, Boolean> isRemovableAttribute(TaskMode mode, String key)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.TaskImpl<T, Boolean>(object, session,
                mode, "isRemovableAttribute", new Class[] { String.class }, key);
    }

    public Task<T, Boolean> isVectorAttribute(TaskMode mode, String key)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.TaskImpl<T, Boolean>(object, session,
                mode, "isVectorAttribute", new Class[] { String.class }, key);
    }

    public Task<T, Boolean> isWritableAttribute(TaskMode mode, String key)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.TaskImpl<T, Boolean>(object, session,
                mode, "isWritableAttribute", new Class[] { String.class }, key);
    }

    public Task<T, String[]> listAttributes(TaskMode mode)
            throws NotImplementedException {
        return new org.ogf.saga.impl.task.TaskImpl<T, String[]>(object,
                session, mode, "listAttributes", new Class[] {});
    }
    ...
    public Task<T, Void> removeAttribute(TaskMode mode, String key)
        ...
        return new org.ogf.saga.impl.task.TaskImpl<T, Void>(object, session,
                mode, "removeAttributes", new Class[] { String.class }, key);
    }
